	...
	<div class="container">
		...
		<form:form class="form-horizontal" modelAttribute="userDto"
			...
			<div class="form-group">
				...
				<label for=cnp>Cnp</label> <input type="text" class="form-control"
					id="cnp" placeholder="CNP" name="cnp">
				<p>
					<form:errors path="cnp" class="control-label" />
				</p>
				...
				<p>
					<form:errors path="address.streetName" class="control-label" />
				</p>
				...
				<p>
					<form:errors path="address.streetNumber" class="control-label" />
				</p>

				<label for=town>Town</label> <input type="text" class="form-control"
					id="town" placeholder="Town" name="address.town">
				<p>
					<form:errors path="address.town" class="control-label" />
				</p>
